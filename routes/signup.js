...
router.post('/', function (req, res) {
    if (req.query.society == "true") {
        ...
        if (errors) {
            ...
            photo.mv('public_html/photos/' + photoname + '.jpg', function (err) {
                if (err) throw err
                else {
        ...
        if (errors) {
            ...
            photo.mv('public_html/photos/' + photoname + '.jpg', function (err) {
                if (err) throw err
                    ...
                    db.actions.person.addNew(Person.name, Person.email, Person.college, Person.bio,photoname, function (data) {
